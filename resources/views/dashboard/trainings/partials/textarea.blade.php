<div class="form-group">
	...
	<div class="col-sm-10">
		...
		<div class="note-editor">
				...
				<div class="note-link-dialog modal" aria-hidden="false">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<!-- estaba etiqueta <form class="note-modal-form"> -->
							<div class="modal-body">
								<div class="row-fluid">
			...
			<div class="note-popover">
				<div class="note-link-popover popover bottom in" style="display: none;">
					...
					<div class="popover-content">
						...
						<div class="note-insert btn-group">
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="showLinkDialog" tabindex="-1" data-original-title="Edit (CTRL+K)">
								<i class="fa fa-edit icon2-edit"></i>
							</button>
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="unlink" tabindex="-1" data-original-title="Unlink">
								<i class="fa fa-unlink icon2-unlink"></i>
							</button>
						</div>
					</div>
				</div>
				<div class="note-image-popover popover bottom in" style="display: none;">
					...
					<div class="popover-content">
						<div class="btn-group">
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="resize" data-value="1" tabindex="-1" data-original-title="Resize Full">
								<span class="note-fontsize-10">100%</span>
							</button>
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="resize" data-value="0.5" tabindex="-1" data-original-title="Resize Half">
								<span class="note-fontsize-10">50%</span>
							</button>
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="resize" data-value="0.25" tabindex="-1" data-original-title="Resize Quarter">
								<span class="note-fontsize-10">25%</span>
							</button>
						</div>
						<div class="btn-group">
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="floatMe" data-value="left" tabindex="-1" data-original-title="Float Left">
								<i class="fa fa-align-left icon2-align-left"></i>
							</button>
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="floatMe" data-value="right" tabindex="-1" data-original-title="Float Right">
								<i class="fa fa-align-right icon2-align-right"></i>
							</button>
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="floatMe" data-value="none" tabindex="-1" data-original-title="Float None">
								<i class="fa fa-align-justify icon2-align-justify"></i>
							</button>
						</div>
						<div class="btn-group">
							<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="removeMedia" data-value="none" tabindex="-1" data-original-title="Remove Image">
								<i class="fa fa-trash-o icon2-trash"></i>
							</button>
						</div>
					</div>
				</div>
		...
		<button type="button" class="btn btn-primary btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="Style">
		<i class="fa fa-magic icon2-magic"></i>
		...
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="bold" tabindex="-1" data-original-title="Bold (CTRL+B)">
		<i class="fa fa-bold icon2-bold"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="italic" tabindex="-1" data-original-title="Italic (CTRL+I)">
		<i class="fa fa-italic icon2-italic"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="underline" tabindex="-1" data-original-title="Underline (CTRL+U)">
		<i class="fa fa-underline icon2-underline"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" data-event="superscript" tabindex="-1" data-original-title="" title="">
		<i class="fa fa-superscript icon2-superscript"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" data-event="subscript" tabindex="-1" data-original-title="" title="">
		<i class="fa fa-subscript icon2-subscript"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="strikethrough" tabindex="-1" data-original-title="Strikethrough (CTRL+SHIFT+S)">
		<i class="fa fa-strikethrough icon2-strikethrough"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="removeFormat" tabindex="-1" data-original-title="Remove Font Style (CTRL+\)">
		<i class="fa fa-eraser icon2-eraser"></i>
		</button>
		</div>
		<div class="note-fontname btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="Font Family" aria-expanded="false">
		<span class="note-current-fontname">Arial</span>
		<span class="caret"></span>
		</button>
		<ul class="dropdown-menu">
		<li>
		<a data-event="fontName" href="#" data-value="Serif">
		<i class="fa fa-check icon2-ok"></i> Serif</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Sans">
		<i class="fa fa-check icon2-ok"></i> Sans</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Arial">
		<i class="fa fa-check icon2-ok"></i> Arial</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Arial Black">
		<i class="fa fa-check icon2-ok"></i> Arial Black</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Courier">
		<i class="fa fa-check icon2-ok"></i> Courier</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Courier New">
		<i class="fa fa-check icon2-ok"></i> Courier New</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Comic Sans MS">
		<i class="fa fa-check icon2-ok"></i> Comic Sans MS</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Helvetica">
		<i class="fa fa-check icon2-ok"></i> Helvetica</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Impact">
		<i class="fa fa-check icon2-ok"></i> Impact</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Lucida Grande">
		<i class="fa fa-check icon2-ok"></i> Lucida Grande</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Lucida Sans">
		<i class="fa fa-check icon2-ok"></i> Lucida Sans</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Tahoma">
		<i class="fa fa-check icon2-ok"></i> Tahoma</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Times">
		<i class="fa fa-check icon2-ok"></i> Times</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Times New Roman">
		<i class="fa fa-check icon2-ok"></i> Times New Roman</a>
		</li>
		<li>
		<a data-event="fontName" href="#" data-value="Verdana">
		<i class="fa fa-check icon2-ok"></i> Verdana</a>
		</li>
		</ul>
		</div>
		<div class="note-color btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small note-recent-color" title="" data-event="color" data-value="{&quot;backColor&quot;:&quot;yellow&quot;}" tabindex="-1" data-original-title="Recent Color">
		<i class="fa fa-font icon2-font" style="color:black;background-color:yellow;"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="More Color">
		<span class="caret"></span>
		</button>
		<ul class="dropdown-menu">
		<li>
		...
		<div><button type="button" class="note-color-btn" style="background-color:#F7C6CE;" data-event="foreColor" data-value="#F7C6CE" title="" data-toggle="button" tabindex="-1" data-original-title="#F7C6CE">
		</button>
		...
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="insertUnorderedList" tabindex="-1" data-original-title="Unordered list (CTRL+SHIFT+NUM7)">
		<i class="fa fa-list-ul icon2-list-ul"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="insertOrderedList" tabindex="-1" data-original-title="Ordered list (CTRL+SHIFT+NUM8)">
		<i class="fa fa-list-ol icon2-list-ol"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="Paragraph">
		<i class="fa fa-align-left icon2-align-left"></i>
		<span class="caret"></span>
		</button>
		<div class="dropdown-menu">
		<div class="note-align btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="justifyLeft" tabindex="-1" data-original-title="Align left (CTRL+SHIFT+L)">
		<i class="fa fa-align-left icon2-align-left"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="justifyCenter" tabindex="-1" data-original-title="Align center (CTRL+SHIFT+E)">
		<i class="fa fa-align-center icon2-align-center"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="justifyRight" tabindex="-1" data-original-title="Align right (CTRL+SHIFT+R)">
		<i class="fa fa-align-right icon2-align-right"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="justifyFull" tabindex="-1" data-original-title="Justify full (CTRL+SHIFT+J)">
		<i class="fa fa-align-justify icon2-align-justify"></i>
		</button>
		</div>
		<div class="note-list btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="indent" tabindex="-1" data-original-title="Indent (CTRL+])">
		<i class="fa fa-indent icon2-indent-right"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="outdent" tabindex="-1" data-original-title="Outdent (CTRL+[)">
		<i class="fa fa-outdent icon2-indent-left"></i>
		</button>
		</div>
		</div>
		</div>
		<div class="note-height btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="Line Height">
		<i class="fa fa-text-height icon2-text-height"></i>
		<span class="caret"></span>
		</button>
		<ul class="dropdown-menu">
		<li><a data-event="lineHeight" href="#" data-value="1"><i class="fa fa-check icon2-ok"></i> 1.0</a></li>
		<li><a data-event="lineHeight" href="#" data-value="1.2"><i class="fa fa-check icon2-ok"></i> 1.2</a></li>
		<li><a data-event="lineHeight" href="#" data-value="1.4"><i class="fa fa-check icon2-ok"></i> 1.4</a></li>
		<li><a data-event="lineHeight" href="#" data-value="1.5"><i class="fa fa-check icon2-ok"></i> 1.5</a></li>
		<li><a data-event="lineHeight" href="#" data-value="1.6"><i class="fa fa-check icon2-ok"></i> 1.6</a></li>
		<li><a data-event="lineHeight" href="#" data-value="1.8"><i class="fa fa-check icon2-ok"></i> 1.8</a></li>
		<li><a data-event="lineHeight" href="#" data-value="2"><i class="fa fa-check icon2-ok"></i> 2.0</a></li>
		<li><a data-event="lineHeight" href="#" data-value="3"><i class="fa fa-check icon2-ok"></i> 3.0</a></li>
		</ul>
		</div>
		<div class="note-table btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="" tabindex="-1" data-original-title="Table">
		<i class="fa fa-table icon2-table"></i>
		<span class="caret"></span>
		</button>
		<ul class="dropdown-menu">
		...
		<div class="note-insert btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="showLinkDialog" tabindex="-1" data-original-title="Link (CTRL+K)">
			<i class="fa fa-link icon2-link"></i>
		</button>
		<!--<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="showImageDialog" tabindex="-1" data-original-title="Picture">
		<i class="fa fa-picture-o icon2-picture"></i>
		</button>-->
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="showVideoDialog" tabindex="-1" data-original-title="Video">
		<i class="fa fa-youtube-play icon2-play"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="insertHorizontalRule" tabindex="-1" data-original-title="Insert Horizontal Rule (CTRL+ENTER)">
		<i class="fa fa-minus icon2-hr"></i>
		</button>
		</div>
		<div class="note-view btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="fullscreen" tabindex="-1" data-original-title="Full Screen">
		<i class="fa fa-arrows-alt icon2-fullscreen"></i>
		</button>
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="codeview" tabindex="-1" data-original-title="Code View">
		<i class="fa fa-code icon2-code"></i>
		</button>
		</div>
		<div class="note-help btn-group">
		<button type="button" class="btn btn-primary btn-sm btn-small" title="" data-event="showHelpDialog" tabindex="-1" data-original-title="Help">
		<i class="fa fa-question icon2-question"></i>
		</button>
		</div>
		</div>
		<textarea class="note-codable"></textarea>
		<div class="note-editable" contenteditable="true" style="height: 500px;">
			@if(isset($training))
